...
<div id="container">
        <form action="" id="formToCheck" onsubmit="return validForm()" method="POST">
            ...
            <input type="text" id="name" placeholder="Entrer le nom d'utilisateur" name="username" required>

            <label><b>Mot de passe</b></label>
            <input type="password" id="mdp" placeholder="Entrer le mot de passe" name="passeword" required>

            <label><b>Email</b></label>
            <input type="text" id="mail" placeholder="Entrer l'adresse e-mail" name="email" required>
